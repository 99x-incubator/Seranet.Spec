                ...
                SubAreas = new List<SubArea> {
                        new SubArea{ GUID=Guid.NewGuid(), Code="MB", Name="Model Bootstrap", 
                            Practices= new List<Practice> {
                                ...
                                new Practice{ GUID=Guid.NewGuid(), Code="MB.1.2", Description="Team should produce evidence to support their claims for completed tasks in order to be certified under a particular practice.", Level = level1 },
                                new Practice{ GUID=Guid.NewGuid(), Code="MB.1.3", Description="Team should have a activity backlog (a roadmap) with specific tasks demonstrating how it plans to progress through the SPEC model.", Level = level1 },
                                new Practice{ GUID=Guid.NewGuid(), Code="MB.1.4", Description="Team should produce evidence that meetings has happened in every iteration to monitor the progress of the SPEC backlog.", Level = level1 }
                            }
                        },
                        new SubArea{ GUID=Guid.NewGuid(), Code="TC", Name="Team Culture", 
                            Practices= new List<Practice> {
                                new Practice{ GUID=Guid.NewGuid(), Code="TC.1.1", Description="Team has a plan (preferably unique) to ensure newcomer are absorbed to their team culture successfully with a high positive note.", Level = level1},
                                new Practice{ GUID=Guid.NewGuid(), Code="TC.1.2", Description="Team has carried out explicit activities to improve peer bonding continuously. Evidences from last quarter are available.", Level = level1 },
                                ...
                                new Practice{ GUID=Guid.NewGuid(), Code="TC.3.1", Description="Members are aware of travel information to the counterpart countries and possess a reasonable knowledge of social practices in conversations, dining, clothing, etc.", Level = level3 },
                                new Practice{ GUID=Guid.NewGuid(), Code="TC.3.2", Description="Team is knowledgeable of the important information such as history, geology, politics, sports, current-affairs, etc. of the counterpart countries.", Level = level3 }
                            }
                        },
                        new SubArea{ GUID=Guid.NewGuid(), Code="BO", Name="Blue Oceans", 
                            Practices= new List<Practice> {
                                new Practice{ GUID=Guid.NewGuid(), Code="BO.1.1", Description="Individuals have explicitly identified a project-domain (technology or business) focus areas for the coming year.", Level = level1},
                                new Practice{ GUID=Guid.NewGuid(), Code="BO.1.2", Description="Team is aware of the project-domain blue oceans selected by the peers and related activities performed by the peers recently.", Level = level1 },
                        ...
                        new SubArea{ GUID=Guid.NewGuid(), Code="CL", Name="Continuous Learning", 
                            Practices= new List<Practice> {
                                ...
                                new Practice{ GUID=Guid.NewGuid(), Code="CL.2.3", Description="Information regarding day-to-day activities of the team is continuously shared across everyone in the distributed team in real-time.", Level = level2}
                            }
                        },
                    }
            };
